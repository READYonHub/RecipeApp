            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} >
                {categories.map((category, index) => {
                    return (
                        ...
                        //unique hiba kezeles key={category.id}
                        <View key={category.id} style={[styles.categoriesListazasStyle, { backgroundColor: index == 0 ? colors.COLOR_PRIMARY : colors.COLOR_LIGHT }]} >
